...
# ## 1.2. <a href="google.com">Download data</a>
...
data = np.loadtxt('../data/thermal-gs.txt').T
...
plt.savefig('../figures/thermal-gs.png', bbox_inches='tight')
plt.savefig('../figures/thermal-gs.pdf', bbox_inches='tight')
plt.show()
